...
<body>
    <div class="basic">
        <div class="menu1">
            <div class="menu2">
                <a style="text-decoration:none" class="menubtn" href="vendor/logout.php">Выйти</a><br><br>
                <a class="menubtn open-popup-3">Справка по сайту</a>
                <a class="menubtn" href="/cabinet.html">Личный кабинет</a>
    ...
    <br>
        <div class="how_often p1" id="how_often">
            ...
            <ul>
                <input name="cc4" type="radio" id="day" value="day" onchange="psu(`day`, `psu`), psu2(`day`,`psu2`)">Несколько раз в день<br><br>
                <input name="cc4" type="radio" id="week" value="week" onchange="psu(`week`, `psu`), psu2(`week`,`psu2`)">Несколько раз в неделю<br><br>
                <input name="cc4" type="radio" id="month" value="month" onchange="psu(`month`, `psu`), psu2(`month`,`psu2`)">Несколько раз в месяц<br><br>
                <input name="cc4" type="radio" id="dk4" value="dk4" onchange="psu(`dk4`, `psu`), psu2(`dk4`,`psu2`)">Затрудняюсь ответить<br><br>
            <div hidden class="howu">
                <p class="ho" id="ho"></p> <input type="text" hidden id="ho1"> <p class="ho2" id="ho2"></p>
            </div>
            </ul> 
            <br>
            <div class="p12">
    ...
    <br>
        <div class="pereferia p1" id="pereferia">
            ...
            <ul>
                <input name="cc8" hidden type="checkbox" id="mntr" value="mntr" onchange="mntr(this.id, `monitor`), mntr2(this.id, `monitor2`)">
                <label id="mntr1" hidden>Монитор</label><br><br>
                <input name="cc8" hidden type="checkbox" id="kbrd" value="kbrd" onchange="kbrd(this.id, `keyboard`), kbrd2(this.id, `keyboard2`)">
                <label id="kbrd1" hidden>Клавиатура</label><br><br>
                <input name="cc8" hidden type="checkbox" id="ms" value="ms" onchange="ms(this.id, `mouse`), ms2(this.id, `mouse2`)">
                <label id="ms1" hidden>Мышь</label><br><br>
                <input name="cc8" hidden type="checkbox" id="hdphns" value="ndphns" onchange="hdphns(this.id, `headphones`), hdphns2(this.id, `headphones2`)">
                <label id="hdphns1" hidden>Наушники</label><br><br>
                <input name="cc8" hidden type="checkbox" id="spkrs" value="spkrs" onchange="spkrs(this.id, `speakers`), spkrs2(this.id, `speakers2`)">
                <label id="spkrs1" hidden>Колонки</label><br><br>
                <input name="cc8" hidden type="checkbox" id="prntr" value="prntr" onchange="prntr(this.id, `printer`), prntr2(this.id, `printer2`)">
    ...
    <br>
        <div class="target p1" id="target">
            ...
            <div class="target1">
                <input name="cc9" type="checkbox" id="lrn" value="lrn" onchange="chase1(`lrn`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase10(`lrn`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Учеба<br><br>
                <input name="cc9" type="checkbox" id="wrk" value="wrk" onchange="chase2(`wrk`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase11(`wrk`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Работа<br><br>
                <input name="cc9" type="checkbox" id="brws" value="brws" onchange="chase3(`brws`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase12(`brws`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Поиск в интернете<br><br>
                <input name="cc9" type="checkbox" id="wtch" value="wtch" onchange="chase4(`wtch`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase13(`wtch`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Просмотр видео/кино/сериалов<br><br>
                <input name="cc9" type="checkbox" id="prgrm" value="prgrm" onchange="chase5(`prgrm`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase14(`prgrm`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Программирование<br><br>
                <input name="cc9" type="checkbox" id="dsgn" value="dsgn" onchange="chase6(`dsgn`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase15(`dsgn`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">3D Дизайн<br><br>
                <input name="cc9" type="checkbox" id="gms" value="gms" onchange="chase7(`gms`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase16(`gms`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Компьютерные игры<br><br>
                <input name="cc9" type="checkbox" id="txt" value="txt" onchange="chase8(`txt`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase17(`txt`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`)">Работа в текстовых редакторах<br><br>
                <input name="cc9" type="checkbox" id="drw" value="drw" onchange="chase9(`drw`,`cpu`,`mb`,`cpuc`,`vram`,`ssd`,`hdd`,`gpu`,`case`,`cost`,`mnblck`,`mnblck2`,`mnblckCost`,`ntbk`,`ntbk2`,`ntbkCost`), chase18(`drw`,`cpu2`,`mb2`,`cpuc2`,`vram2`,`ssd2`,`hdd2`,`gpu2`,`chase2`,`cost2`,`mnblck`,`mnblck3`,`mnblckCost3`,`ntbk`,`ntbk3`,`ntbkCost3`), hide(this.id, `gp`)">Рисование<br><br>
            </div>
            <br>
            <div hidden id="gp">
    ...
    <div hidden  class="computer grid-item1" id="computer">
                ...
                <form action="vendor/create.php" method="post">
                    <textarea hidden readonly id="login" name="login"> <?= $_SESSION['user']['login']?> </textarea>
                    <textarea hidden readonly id="cpu2" name="cpu2"></textarea>
                    <textarea hidden readonly id="mb2" name="mb2"></textarea>
                    <textarea hidden readonly id="cpuc2" name="cpuc2"></textarea>
                    <textarea hidden readonly id="vram2" name="vram2"></textarea>
                    <textarea hidden readonly id="psu2" name="psu2"></textarea>
                    <textarea hidden readonly id="ssd2" name="ssd2"></textarea>
                    <textarea hidden readonly id="hdd2" name="hdd2"></textarea>
                    <textarea hidden readonly id="gpu2" name="gpu2"></textarea>
                    <textarea hidden readonly id="chase2" name="chase2"></textarea>
                    <textarea hidden readonly id="cost2" name="cost2"></textarea>
                        <button class="sbrs gridForm-item1" id="btn-export" type="submit">Сохранить на аккаунте</button>
                        <button class="sbrs gridForm-item2 open-popup-PC">Справка о комлпектующих</button>
                        <button class="sbrs gridForm-item3" id="btn-export" onclick="exportPC();">Сохранить на устройство</button>
                        <a href='https://vkontakte.ru/share.php?url=Ссылка' target='_blank'><img src='https://img-fotki.yandex.ru/get/6440/40839264.b/0_92085_e23512a0_XS.gif' border='0' width='32' height='32' alt='Как установить кнопку Поделиться vk на ваш сайта' title='Поделиться ВКонтакте'></a>
                </form>
            </div>
            <div hidden class="monoblock grid-item2" id="monoblock">
                ...
                <form action="vendor/create.php" method="post">
                    <textarea readonly hidden id="login" name="login"> <?= $_SESSION['user']['login']?> </textarea>
                    <textarea readonly hidden id="mnblck3" name="mnblck2"></textarea>
                    <textarea readonly hidden id="mnblckCost3" name="mnblckCost"></textarea>
                    <button class="sbrs" id="btn-export" type="submit">Сохранить на аккаунте</button>
                    <button class="sbrs open-popup-PC">Справка о Моноблоках</button>
                    <button class="sbrs" id="btn-export" onclick="exportMNBLCK();">Сохранить на устройство</button>
                    <a href='https://vkontakte.ru/share.php?url=Ссылка' target='_blank'><img src='https://img-fotki.yandex.ru/get/6440/40839264.b/0_92085_e23512a0_XS.gif' border='0' width='32' height='32' alt='Как установить кнопку Поделиться vk на ваш сайта' title='Поделиться ВКонтакте'></a>
                </form>
            </div>
            <div hidden class="notebook grid-item3" id="notebook" >
                ...
                <form action="vendor/create.php" method="post">
                    <textarea readonly hidden id="login" name="login"> <?= $_SESSION['user']['login']?> </textarea>
                    <textarea readonly hidden id="ntbk3" name="ntbk3"></textarea>
                    <textarea readonly hidden id="ntbkCost3" name="ntbkCost3"></textarea>
                    <button class="sbrs" id="btn-export" type="submit">Сохранить на аккаунте</button>
                    <button class="sbrs open-popup-PC">Справка о Ноутбуках</button>
                    <button class="sbrs" id="btn-export" onclick="exportNTBCK();">Сохранить на устройство</button>
                    <a href='https://vkontakte.ru/share.php?url=Ссылка' target='_blank'><img src='https://img-fotki.yandex.ru/get/6440/40839264.b/0_92085_e23512a0_XS.gif' border='0' width='32' height='32' alt='Как установить кнопку Поделиться vk на ваш сайта' title='Поделиться ВКонтакте'></a>
                </form>
            </div>
            <div class="prph grid-item4" id="prph" hidden>
                ...
                <form action="vendor/create.php" method="post">
                    <textarea readonly hidden id="login" name="login"> <?= $_SESSION['user']['login']?> </textarea>
                    <textarea readonly hidden id="monitor2" name="monitor2"></textarea>
                    <textarea readonly hidden id="keyboard2" name="keyboard2"></textarea>
                    <textarea readonly hidden id="mouse2" name="mouse2"></textarea>
                    <textarea readonly hidden id="headphones2" name="headphones2"></textarea>
                    <textarea readonly hidden id="speakers2" name="speakers2"></textarea>
                    <textarea readonly hidden id="printer2" name="printer2"></textarea>
                    <button class="sbrs" id="btn-export" type="submit">Сохранить на аккаунте</button>
                    <button class="sbrs open-popup-PC">Справка о переферии</button>
                    <button class="sbrs" id="btn-export" onclick="exportPRPH();">Сохранить на устройство</button>
                    <a href='https://vkontakte.ru/share.php?url=Ссылка' target='_blank'><img src='https://img-fotki.yandex.ru/get/6440/40839264.b/0_92085_e23512a0_XS.gif' border='0' width='32' height='32' alt='Как установить кнопку Поделиться vk на ваш сайта' title='Поделиться ВКонтакте'></a>
                </form>
            </div>
        </div>
